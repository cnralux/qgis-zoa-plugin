...
class ImportGML(Importer):
    ...
    def runImport(self):
        ...
        # XSD Schema
        xsdschema = ZOALuxembourg.main.xsd_schema
        ...
        progressMessageBar = ZOALuxembourg.main.qgis_interface.messageBar().createMessage(QCoreApplication.translate('ImportGML', 'Importing GML'))
    ...
    def _importGmlLayer(self, gml_layer, xsdtype, progress):
        ...
        :type xsdtype: ZOAType
        '''

        xsd_layer = ZOALuxembourg.main.current_project.getLayer(xsdtype)
